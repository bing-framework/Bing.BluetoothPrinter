namespace Bing.BluetoothPrinter.Zicox
{
    ...
    public partial class ZicoxPrintClient
    {
        ...
        public ZicoxPrintClient Text(int font, int size, int x, int y, string data) => WriteRawLine($"T {font} {size} {x} {y} {data}");
        ...
        /// <param name="data">要打印的文本</param>
        /// <remarks>横向打印文本。</remarks>
        public ZicoxPrintClient Text(string font, int size, int x, int y, string data) => WriteRawLine($"T {font} {size} {x} {y} {data}");
        ...
        public ZicoxPrintClient Text90(string font, int size, int x, int y, string data) => WriteRawLine($"T90 {font} {size} {x} {y} {data}");
        ...
        public ZicoxPrintClient Text180(string font, int size, int x, int y, string data) => WriteRawLine($"T180 {font} {size} {x} {y} {data}");
        ...
        public ZicoxPrintClient Text270(string font, int size, int x, int y, string data) => WriteRawLine($"T270 {font} {size} {x} {y} {data}");
        ...
        public ZicoxPrintClient VText(string font, int size, int x, int y, string data) => WriteRawLine($"VT {font} {size} {x} {y} {data}");
        ...
        /// </remarks>
        public ZicoxPrintClient FontGroup(int fg, params (string fn, int fs)[] param)
        {
            var sb = string.Empty;
        ...
        public ZicoxPrintClient Concat(int x, int y, params string[] param)
        {
        ...
        /// <param name="param">参数格式：字体名称-字体大小-偏移量-文本</param>
        /// <remarks>使用文本串联，可以为字符串分配不同的字符样式，在同一文本行上使用统一间距进行打印。这项命令可以与可缩 放字体组合使用。请参见可缩放串联命令。</remarks>
        public ZicoxPrintClient Concat(int x, int y, params (string font, int size, int offset, string data)[] param)
        {
            WriteRawLine($"CONCAT {x} {y}");
            foreach (var item in param) 
        ...
        /// <param name="param">参数格式：字体名称-字体大小-偏移量-文本</param>
        /// <remarks>使用文本串联，可以为字符串分配不同的字符样式，在同一文本行上使用统一间距进行打印。这项命令可以与可缩 放字体组合使用。请参见可缩放串联命令。</remarks>
        public ZicoxPrintClient VConcat(int x, int y, params string[] param)
        {
        ...
        /// <param name="param">参数格式：字体名称-字体大小-偏移量-文本</param>
        /// <remarks>使用文本串联，可以为字符串分配不同的字符样式，在同一文本行上使用统一间距进行打印。这项命令可以与可缩 放字体组合使用。请参见可缩放串联命令。</remarks>
        public ZicoxPrintClient VConcat(int x, int y, params (string font, int size, int offset, string data)[] param)
        {
            WriteRawLine($"VCONCAT {x} {y}");
            foreach (var item in param)
                WriteRawLine($"{item.font} {item.size} {item.offset} {item.data}");
        ...
        public ZicoxPrintClient MultiLine(int height, string textCmd, string font, int size, int x, int y,
            params string[] data)
        {
        ...
        /// </remarks>
        public ZicoxPrintClient Count(int count) => WriteRawLine($"COUNT {count}");
        ...
        /// </remarks>
        public ZicoxPrintClient SetMag(int w, int h) => WriteRawLine($"SETMAG {w} {h}");
        ...
        public ZicoxPrintClient ScalableText(string name, int width, int height, int x, int y, string data) => WriteRawLine($"ST {name} {width} {height} {x} {y} {data}");
        ...
        /// <param name="data">要打印的文本</param>
        /// <remarks>使用可缩放文本，用户可以打印任何字体大小的文本。通过指定 X 和 Y 两个方向上的字体大小，可以生成宽度或 高度经过“缩放”的字符。指定的字体大小和生成的文本将以 72 点，即 1 英寸（25.4 毫米）打印出来</remarks>
        public ZicoxPrintClient VScalableText(string name, int width, int height, int x, int y, string data) => WriteRawLine($"VST {name} {width} {height} {x} {y} {data}");
        ...
        public ZicoxPrintClient ScaleToFit(string name, int width, int height, int x, int y, string data) => WriteRawLine($"STF {name} {width} {height} {x} {y} {data}");
        ...
        /// <param name="data">要打印的文本</param>
        /// <remarks>SCALE-TO-FIT 命令可自动计算文本的比例，确保文本不超出窗口范围。</remarks>
        public ZicoxPrintClient VScaleToFit(string name, int width, int height, int x, int y, string data) => WriteRawLine($"VSTF {name} {width} {height} {x} {y} {data}");
        ...
        public ZicoxPrintClient ScalableConcat(int x, int y, params (string name, int width, int height, int offset, string data)[] param)
        {
            WriteRawLine($"CONCAT {x} {y}");
            foreach (var item in param)
        ...
        /// <param name="param">参数：字体名称-字体宽度-字体高度-偏移量-文本</param>
        /// <remarks>使用可缩放串联，可以为字符串分配不同的字符样式，在同一文本行上使用统一间距进行打印。可缩放和位图文本 组合到 CONCAT/ENCONCAT 命令中</remarks>
        public ZicoxPrintClient VScalableConcat(int x, int y, params (string name, int width, int height, int offset, string data)[] param)
        {
            WriteRawLine($"VCONCAT {x} {y}");
            foreach (var item in param)
                WriteRawLine($"ST {item.name} {item.width} {item.height} {item.offset} {item.data}");
        ...
        public ZicoxPrintClient Rotate(int angle) => WriteRawLine($"R {angle}");
    }
}
