namespace Bing.BluetoothPrinter.Zicox
{
    ...
    public partial class ZicoxPrintClient
    {
        ...
        /// </remarks>
        public ZicoxPrintClient Print() => WriteRawLine("PRINT");
        ...
        public ZicoxPrintClient Encoding(string encoding) => WriteRawLine($"ENCODING {encoding}");

        /// <summary>
        /// FORM 命令
        /// </summary>
        /// <remarks>FORM 命令可以指示打印机在一页打印结束后切换至下一页顶部。 </remarks>
        public ZicoxPrintClient Form() => WriteRawLine("FORM");
        ...
        public ZicoxPrintClient Journal() => WriteRawLine("JOURNAL");
    }
}
