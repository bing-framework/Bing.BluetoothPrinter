namespace Bing.BluetoothPrinter.Zicox
{
    ...
    public partial class ZicoxPrintClient
    {
        ...
        public ZicoxPrintClient Barcode(string type, int width, int ratio, int height, int x, int y, string data) => WriteRawLine($"B {type} {width} {ratio} {height} {x} {y} {data}");
        ...
        /// <param name="data">条码数据</param>
        /// <remarks>BARCODE 命令能够以指定的宽度和高度纵向和横向打印条码。</remarks>
        public ZicoxPrintClient VBarcode(string type, int width, int ratio, int height, int x, int y, string data) => WriteRawLine($"VB {type} {width} {ratio} {height} {x} {y} {data}");
        ...
        /// </remarks>
        public ZicoxPrintClient BarcodeText(string font, int size, int offset) => WriteRawLine($"BT {font} {size} {offset}");
        ...
        /// 使用 BARCODE-TEXT OFF（或 BT OFF）可以禁用它。
        /// </remarks>
        public ZicoxPrintClient BarcodeTextOff() => WriteRawLine("BT OFF");
        ...
        public ZicoxPrintClient BarcodeRss(int x, int y, int width, int linHeight, int sepHeight, int segments, int subType, string dataLine, string data2D) => WriteRawLine($"B RSS {x} {y} {width} {linHeight} {sepHeight} {segments} {subType} {dataLine}|{data2D}");
    }
}
